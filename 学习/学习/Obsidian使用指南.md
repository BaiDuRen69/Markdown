...
将自己的笔记上传就可使用ima来搭建自己的知识库，还可以看看别人的知识库  

当然这其实很麻烦，所以建议感兴趣的去尝试

当你将你的笔记上传后，你或许会发现WorkBudd背靠腾讯的强大，它能接入ima  

但也正因workbuddy能接入很多应用，所以ima显得不那么重要，你大可去尝试下其他的方式  

## 为什么用Obsidian

### 免费，支持插件

支持插件就可以自己写插件实现自己想要的功能

当然不会也完全可以让AI生成  

### 双链、知识图谱、标签等让我在写笔记时将之前的笔记联系在一起

![Obsidian 双链与知识图谱](Obsidian%20双链与知识图谱.md#^fb93e4)

详细可看[Obsidian 双链与知识图谱](Obsidian%20双链与知识图谱.md)

当然由于我将笔记放在github，所以我并不会用到太过花哨的操作
